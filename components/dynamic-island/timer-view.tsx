...
export function TimerView() {
  ...
  return (
    <div className="flex w-full items-center gap-2 py-3 pl-3.5 pr-5">
      <motion.button
        ...
        whileTap={{ scale: 0.9 }}
        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#5A3C07] transition-colors hover:bg-[#694608]"
      >
